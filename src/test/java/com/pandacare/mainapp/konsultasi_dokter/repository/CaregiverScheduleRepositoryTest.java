...
public class CaregiverScheduleRepositoryTest {
    ...
    @Autowired
    private CaregiverScheduleRepository repository;    private CaregiverSchedule schedule1;
    ...
    public void setup() {
        ...
        caregiver = new Caregiver("Dr. Test", "1234567890", "08123456789", "Test Address", "General Practice");
        caregiver = entityManager.persistAndFlush(caregiver);
        caregiverId = caregiver.getId();

        schedule1 = createSchedule(caregiver, DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(10, 0), ScheduleStatus.AVAILABLE);
        CaregiverSchedule schedule2 = createSchedule(caregiver, DayOfWeek.TUESDAY, LocalTime.of(9, 0), LocalTime.of(10, 0), ScheduleStatus.UNAVAILABLE);
        CaregiverSchedule schedule3 = createSchedule(caregiver, DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(10, 0), ScheduleStatus.AVAILABLE);
    ...
    private CaregiverSchedule createSchedule(Caregiver caregiver, DayOfWeek day, LocalTime startTime, LocalTime endTime, ScheduleStatus status) {
    ...
    public void testSaveSchedule() {
        Caregiver newCaregiver = new Caregiver("Dr. New", "9876543210", "08198765432", "New Address", "Cardiology");
        newCaregiver = entityManager.persistAndFlush(newCaregiver);
        
        CaregiverSchedule newSchedule = createSchedule(newCaregiver, DayOfWeek.THURSDAY,
        ...
        assertThat(found.getIdCaregiver()).isEqualTo(newCaregiver.getId());
    ...
    public void testSaveAll() {
        Caregiver newCaregiver = new Caregiver("Dr. Another", "5555555555", "08155555555", "Another Address", "Dermatology");
        newCaregiver = entityManager.persistAndFlush(newCaregiver);

        CaregiverSchedule newSchedule1 = createSchedule(newCaregiver, DayOfWeek.FRIDAY,
                LocalTime.of(9, 0), LocalTime.of(10, 0), ScheduleStatus.AVAILABLE);
        CaregiverSchedule newSchedule2 = createSchedule(newCaregiver, DayOfWeek.SATURDAY,
                LocalTime.of(9, 0), LocalTime.of(10, 0), ScheduleStatus.AVAILABLE);
        ...
        List<CaregiverSchedule> found = repository.findByIdCaregiver(newCaregiver.getId());
